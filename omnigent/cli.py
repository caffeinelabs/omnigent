...
def server(
    ...
    # GitHub App integration (per-user "Connect GitHub" + per-user
    # sandbox auth). Enabled only when OMNIGENT_GITHUB_APP_* env supplies
    # a client id/secret + resolvable redirect URI; otherwise both stay
    # None and the feature is inert (see designs/GITHUB_APP_SANDBOX_AUTH.md).
