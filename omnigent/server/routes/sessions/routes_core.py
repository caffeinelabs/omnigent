    ...
    *,
    ...
    async def _schedule_managed_launch(
        ...
        *,
        ...
        raw_workspaces: list[str] = list(workspaces) if workspaces else []
        if not raw_workspaces and workspace is not None:
            raw_workspaces = [workspace]
        ...
        if raw_workspaces:
            ...
            # sandbox relaunch can re-clone the same repositories.
    ...
    async def _create_bundled_session_from_multipart(
        ...
        if parsed_metadata.host_type == "managed" and inherited_runner_id is None:
            await _schedule_managed_launch(
                ...
                workspace=parsed_metadata.workspace,
                workspaces=parsed_metadata.workspaces,
            )
