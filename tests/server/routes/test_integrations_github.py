...
def test_session_pulls_scopes_to_author_and_session_start(
    ...
    resp = tc.get("/v1/connections/github/sessions/conv_1/pull-requests", headers=_USER)
    assert resp.status_code == 200
    body = resp.json()
    assert body["connected"] is True
...
def test_session_pulls_empty_when_no_matching_link(
    ...
    resp = tc.get("/v1/connections/github/sessions/conv_2/pull-requests", headers=_USER)
    assert resp.status_code == 200
...
def test_session_pulls_unconnected_returns_false(db_uri: str) -> None:
    ...
    resp = tc.get("/v1/connections/github/sessions/conv_3/pull-requests", headers=_USER)
    assert resp.status_code == 200
...
def test_session_pulls_missing_session_404(db_uri: str) -> None:
    ...
    resp = tc.get("/v1/connections/github/sessions/nope/pull-requests", headers=_USER)
...
def test_session_pulls_denies_non_owner_with_permission_store(db_uri: str) -> None:
    ...
    resp = tc.get(
        "/v1/connections/github/sessions/conv_1/pull-requests",
